...
def create_button(parent, text, command, row, column, padx=5, pady=5, sticky=tk.W+tk.E+tk.N+tk.S, width=None, height=None, font=('Arial', 10)):
    kwargs = {}
    if width:
        kwargs["width"] = width
    if height:
        kwargs["height"] = height
    btn = tk.Button(parent, text=text, command=command, width=width, height=height, font=font)
...
class LibraryApp:
    def __init__(self, root):
        ...
        self.output_widget.insert(tk.END, "Версия библиотеки 0.42\n")
