...
def create_button(parent, text, command, row, column, image_path="кнопка.png", padx=5, pady=5, sticky=tk.W+tk.E+tk.N+tk.S, width=None, height=None, font=('Arial', 10), compound=tk.CENTER):
    image = Image.open(image_path)
...
class LibraryApp:
    def __init__(self, root):
        ...
        self.entry_frame.image = Image.open("Фон кнопки.jpg")
        self.entry_frame.photo = ImageTk.PhotoImage(self.entry_frame.image)
